...
public class Presenter {
	...
	public void eventoIniciar(JTextField figuAlbum, JTextField figuPaquete, JTextField cantUser, JTextField simulaciones) {
		...
		_model.setCantSimulaciones(Integer.parseInt(simulaciones.getText()));
